...
<AnchorLinks>
  ...
  <AnchorLink>6-4: Set Up Policies</AnchorLink>
  <AnchorLink>6-5: Summary</AnchorLink>
</AnchorLinks>
...
## 6-3:  Set Up Policies In Turbonomic
...
![](images/turboNewAutoPolicy.png)

4) Select `Business Application` policy for the Robot Shop application.

5) Fill in the name `Robot Shop Response Time SLO Policy`

6) Click on `ADD BUSINESS APPLICATION GROUP`. 

![](./images/turbo-configure-business-application-policy-1.jpg)

7) You will notice there is no group to be selected.

![Turbonomic Configure Business Application Policy - select group](./images/turbo-configure-business-application-policy-2.jpg)
...
8) Create a new group by clicking on the `NEW GROUP` button

9) Enter the group name as `Robot Shop Group` and select `Dynamic` type

![Turbonomic Configure Business Application Policy - create group](./images/turbo-configure-business-application-policy-3.jpg)
...
10) Click on `ADD FILTER` and select `NAME`

11) Select filter `Equals` and enter the regular expression `.*robot.*`. Click `Apply` button

![Turbonomic Configure Business Application Policy - filter group](./images/turbo-configure-business-application-policy-4.jpg)

12) Click `Save Group` button

13) Now you can select `Robot Shop Group` and hit `Select` button

![Turbonomic Configure Business Application Policy - select group](./images/turbo-configure-business-application-policy-5.jpg)

14) Expand `Operational Constraints` section

![Turbonomic Configure Business Application Policy - expand operational constraints](./images/turbo-configure-business-application-policy-6.jpg) 

15) Select the following operation constraints for Response Time SLO of 1ms

![Turbonomic Configure Business Application Policy - select operational constraints](./images/turbo-configure-business-application-policy-7.jpg)

16) Then click `SAVE AND APPLY` button. With the policy configured, Turbonomic will analyze performance data over time and then provide placement and resource sizing recommendations.

17) To edit a policy, click on the policy. Example:

![Turbonomic Edit Policy](./images/turbo-edit-policy.jpg)
...
19) The policy you have created can be found in the `Automation Policies`

![Turbonomic Configure Business Application Policy - policy created](./images/turbo-configure-business-application-policy-8.jpg)

20) The `Imported Placement Policies` is specifically for imported on-prem policies

![Turbonomic Imported Placement Policies](./images/turbo-imported-placement-policies.jpg)

21) The `Defaults` filter represents the policies that govern entire entity types

![Turbonomic Defaults Policies](./images/turbo-defaults-policy.jpg)
