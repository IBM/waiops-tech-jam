...
2) In the create API token page, enter the token name, e.g. `Turbonomic API Token`. Copy the API token generated which will be used later. Enable the permissions as below:
