...
1) As a cluster administrator, create a project in the OCP cluster where KubeTurbo will be deployed. Navigate to `Home -> Projects` and click on `Create Project` button.

![](https://raw.githubusercontent.com/evat-pm/images/master/KOH-createProject.png?raw=true)

2) Select that project, and then deploy an operator here.
...
2) Search for the `Certified` KubeTurbo operator (note, do not use Community edition)

![](https://raw.githubusercontent.com/evat-pm/images/master/KOH-searchHub.png?raw=true)

3) Select, and you will perform a Basic Install (only option)

![](https://raw.githubusercontent.com/evat-pm/images/master/KOH-basicInstall1.png?raw=true)
