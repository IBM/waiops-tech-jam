...
> **Important:** Perform this installation procedure from your **control** node as the **jammer** user.
...
1. Login into the OpenShift Console UI (`manage-from` cluster) and get your login token:
   ...
   - From the new tab that opens, copy the login command from the **Log in with this token** section.
   - Paste the copied command into your SSH terminal on your control node. You should see something like.
...
> **Note:**
>
> - If attending a scheduled Tech Jam, your lab proctors will provide you the license file.
> - If following these instructions offline outside a scheduled Tech Jam, the license file can be found within your
