...
```
 ...
 Encrypt and copy the default Cassandra password (CASSANDRA_DEFAULT_PASSWORD) using the following commands. When prompted, enter <CASSANDRA PASSWORD\> as the password:
