...
<AnchorLinks>
  ...
  <AnchorLink>7-2: Verify the Watson AIOps AI Manager installation</AnchorLink>
  <AnchorLink>7-3: Generating an API key</AnchorLink>
  <AnchorLink>7-4: Sending training data to the Watson AIOps API</AnchorLink>
  <AnchorLink>7-5: Confirm that the training data was received</AnchorLink>
  <AnchorLink>7-6: Running the training job</AnchorLink>
  <AnchorLink>7-7: Sending anomalous data</AnchorLink>
  <AnchorLink>7-8: Viewing the results</AnchorLink>
  <AnchorLink>7-9: Lab summary</AnchorLink>
</AnchorLinks>
...
## 7-2: Verify the Watson AIOps AI Manager installation
 ...
 Open a shell on your control node, switch context to your 'manage from' environment, then verify that your AI Manager installation has completed successfully:
