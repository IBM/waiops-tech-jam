...
If you missed yesterday's Event Manager labs, you will need to do the first few steps of the lab to create the catalog source. If your cluster already has the catalog source and Event Manager installed, you may proceed.
...
The install will take around 90 minutes, and will be ready for you when you come to Lab 4 - working with Metric Anomaly Detection in Watson AIOps.
