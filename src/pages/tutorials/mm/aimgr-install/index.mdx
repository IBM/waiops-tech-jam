...
If you missed yesterday's Event Manager labs, you will need to log in to your cluster and follow the first part of *step 5*, Lab 2, where you import the yaml to create the catalog source: 

https://ibm.github.io/waiops-tech-jam/tutorials/aiops/installation#2-6:-deploy-an-instance-of-watson-for-aiops-event-manager
