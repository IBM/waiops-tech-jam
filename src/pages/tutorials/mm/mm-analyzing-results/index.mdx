...
<AnchorLinks>
  ...
  <AnchorLink>4-2: Accessing the dashboard</AnchorLink>
  <AnchorLink>4-3: The anomaly search view</AnchorLink>
  <AnchorLink>4-4: Launching anomaly details</AnchorLink>
  <AnchorLink>4-5: Viewing alarms in Event Manager</AnchorLink>
  <AnchorLink>4-6: Metric search</AnchorLink>
  <AnchorLink>4-7: Anomaly distribution dashboard</AnchorLink>
</AnchorLinks>
...
## 4-5: Viewing alarms in Event Manager
...
## 4-7: Anomaly distribution dashboard
