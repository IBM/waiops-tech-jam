...
Create scope_events.sh using below script to insert sample events. Please ensure you are logged into your probe server (pi-template) and your current OCP project is "noi" before executing the scripts below.
...
Create super_group_events.sh using below script to insert sample events. Please ensure you are logged into your probe server (pi-template) and your current OCP project is "noi" before executing the scripts below.
