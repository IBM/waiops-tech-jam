...
Create scope_events.sh using below script to insert sample events. Please ensure you current OCP project is "noi" before executing the scripts below.
...
Create super_group_events.sh using below script to insert sample events. Please ensure your current OCP project is "noi" before executing the scripts below.
