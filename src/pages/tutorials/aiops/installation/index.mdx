...
<AnchorLinks>
  ...
  <AnchorLink>2-3: Prepare your OpenShift cluster</AnchorLink>
  <AnchorLink>2-4: Install the Watson for AIOps Event Manager Operator</AnchorLink>
  <AnchorLink>2-5: Deploy an instance of Watson for AIOps Event Manager</AnchorLink>
  <AnchorLink>2-6: Locate your login details and log in to Watson for AIOps Event Manager</AnchorLink>
</AnchorLinks>
...
## 2-3: Prepare your OpenShift cluster
...
Next, open a web browser and navigate to **ibm.com** to obtain your **entitlement key** that is assigned to your IBM ID which will grant you access to the IBM Entitled Registry. Copy this into a text editor in preparation for the next step. This will be needed for deploying an instance of Event Manager.
...
## 2-4: Install the Watson for AIOps Event Manager Operator
...
## 2-5: Deploy an instance of Watson for AIOps Event Manager
...
## 2-6: Locate your login details and log in to Watson for AIOps Event Manager
