...
**a) Log in to the Netcool/OMNIbus Probe server:**
...
Edit the interfaces file located in: `$NCHOME/etc/omni.dat` and add the following entry to the end of the file:
