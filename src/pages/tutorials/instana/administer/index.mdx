...
<AnchorLinks>
  <AnchorLink>6-1: Create an Alert Channel</AnchorLink>
  <AnchorLink>6-2: Create an Analytics Based Smart Alert</AnchorLink>
  <AnchorLink>6-3: Create a Static Threshold (Event)</AnchorLink>
  <AnchorLink>6-4: Setting up an Offline Event</AnchorLink>
  <AnchorLink>6-5: Setup an Alert for the New Event</AnchorLink>
  <AnchorLink>6-6: Summary</AnchorLink>
</AnchorLinks>

# 6-1:  Create an Alert Channel
...
# 6-2:  Create an Analytics Based Smart Alert
...
# 6-3:  Create a Static Threshold (Event)
...
***
# 6-4:  Setting up an Offline Event
...
# 6-5:  Setup an Alert for the New Event
