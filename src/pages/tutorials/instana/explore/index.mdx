...
<AnchorLinks>
  ...
  <AnchorLink>5-3: Create an Application Perspective for Robot Shop</AnchorLink>
  <AnchorLink>5-4: Create an Application Perspective for QOTD</AnchorLink>
  <AnchorLink>5-5: Explore the Application</AnchorLink>
  <AnchorLink>5-6: Websites and Mobile App monitoring</AnchorLink>
...
##  5-3:  Create an Application Perspective for Robot Shop
...
##  5-4:  Create an Application Perspective for QOTD
...
## 5-6:  Websites and Mobile App Monitoring
