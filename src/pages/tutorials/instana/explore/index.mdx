...
<AnchorLinks>
  <AnchorLink>5-1: Explore Kubernetes</AnchorLink>
  <AnchorLink>5-2: Explore the Infrastructure View</AnchorLink>
  <AnchorLink>5-3: Create an Application Perspective</AnchorLink>
  <AnchorLink>5-4: Explore the Application</AnchorLink>
  <AnchorLink>5-5: Websites and Mobile App monitoring</AnchorLink>
...
## 5-2:  Explore the Infrastructure View
...
Or, you can use the lucene query language in the filter/search bar at the top of the page.  Before beginning the search, flyover one of the towers and identify the hostname of one of the servers.  For example jam-stack-dal10-01-mqace.aiops-demo.ibm.net.
...
##  5-3:  Create an Application Perspective
...
Swich to the Advanced View Mode  in the upper right corner. Then complete the definition to look like below.  As you add filters, you'll notice that Instana automatically populates the fields like the service name.  
...
## 5-5:  Websites and Mobile App Monitoring
...
Navigate to section 6 of the lab where we will investigate the Administrative capabilities within Instana.
