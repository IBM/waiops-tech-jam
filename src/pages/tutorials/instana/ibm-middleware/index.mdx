...
<AnchorLinks>
  ...
  <AnchorLink>5-2: Installing the Instana agents</AnchorLink>
  <AnchorLink>
    5-3: Configure Quote of the Day Application to use MQ & ACE
  </AnchorLink>
  <AnchorLink>5-4: Configure ACE and MQ for Resource Monitoring</AnchorLink>
  <AnchorLink>5-5: Configure ACE and MQ for Tracing</AnchorLink>
  <AnchorLink>5-6: Configure the ACE and MQ Sensors</AnchorLink>
  <AnchorLink>5-7: Further Configuration</AnchorLink>
  <AnchorLink>5-8: Summary</AnchorLink>
</AnchorLinks>
...
## 5-2: Installing the Instana agents
...
2. Login through SSH to the MQ/ACE virtual machine. You can ssh from the control node. Then use sudo to switch to the root user:
...
In this section, you will perform these commands as root on the ACE/MQ server. From the control node, ssh to the ACE/MQ server. Then, use sudo to switch to the root user.

```sh
ssh <IP of ACE/MQ server\>
