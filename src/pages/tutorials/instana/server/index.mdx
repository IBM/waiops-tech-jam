...
<span style="color:red">If the instana command is not found, rerun the previous block of commands one at a time and make sure to execute the "apt-get install instana-console -y" command.</span>
