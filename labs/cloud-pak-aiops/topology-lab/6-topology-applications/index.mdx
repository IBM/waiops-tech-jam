...
condition and action sets. They can be triggered to reduce noise by suppressing alerts or grouping alerts together, automatically 
...
that performs a specific function directly for an end user or, in some cases, for another Application. For the rest of the Lab, we
will just use the term *Application*. 
...
allows the prioritization of incident resolution based on the business criticality that has been preassigned to the application.
...
* In the **Business criticality** field, select **Tier 3**.
...
**This concludes the Cloud Pak for AIOps Topology Lab**
