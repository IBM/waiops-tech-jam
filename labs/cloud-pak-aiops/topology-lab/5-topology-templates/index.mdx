...
- Give the template a name (e.g. router1)
...
The Dynamic group template is probably the most versatile of the three topology group
...
resources that match the *recipe*. The first group resources were in the original application resources data. The second group resources were added
by the Observer job we just run. In summary, we defined a dynamic template that creates groups for every compute resource 
