...
- Update the existing **Authorization** header with the following details:
...
- Scroll down and select **Test Connection**. Verify it responds with **Connection OK**
