...
Open a command terminal, connect to the ObjectServer VM via SSH. Type **netcool** when prompted for the password
```
...
```
ALTER TABLE alerts.status ADD COLUMN CustomCorrelation1 VARCHAR(64)
go
```
...
- Add the new **details.customCorrelation1** field to your View as you did in [lab 3.5](../3-netcool-connector/index.mdx)
