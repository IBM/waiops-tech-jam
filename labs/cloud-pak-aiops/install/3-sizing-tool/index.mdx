...
Both, the OpenShift cluster and the Cloud Pak for Watson AIOps can be sized in two different ways. 
...
The IBM Cloud Pak for Watson AIOps Custom Sizing Tool is intended to be used 
