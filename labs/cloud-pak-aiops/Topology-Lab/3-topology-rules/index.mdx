...
cane be found in the product [**documentation**](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=elements-configuring-rules).
:::
...
of indexed properties, see [Properties](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=reference-properties).
