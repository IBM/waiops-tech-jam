...
Make sure you can login as **admin**, as shown below, using the password from the previous command. Note that 
you will get a security **Warning: Potential Security Risk Ahead**. This is because we have used 
