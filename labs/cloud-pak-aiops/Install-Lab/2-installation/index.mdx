...
## 2.4: Install the Cloud Pak for AIOps Operator
...
of the Cloud Pak for AIOps in the next section.
...
to use in later steps. [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#exp_namespace)
...
required RBAC (Role Base Access Control) access for its member Operators. [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#op_group)
...
will be used to pull installation images. [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#exp_pull_secret)
...
Use the values shown below for the environment variables. [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#usage_secret)
...
in case the ingresscontroller its set to HostNetwork. [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#exp_ingress)
...
disregard the section about disabling the automatic initiation of patch upgrades. [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#exp_catalog)
...
Finally, we are ready to install the Operator. Do not move to the next step until you can confirm that
 the Operator is fully installed by running the verification command provided in the documentation. [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#exp_operator)


The Cloud Pak for AIOps Operator is now installed and ready to create a product instance.



## 2.5: Deploy an instance of Cloud Pak for AIOps

This final step of deployment involves deploying a running instance of the product onto the OpenShift cluster.
Make sure you have updated the following values in the yaml file before running the command [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#exp_instance)
...
instance of the Cloud Pak for AIOps. Follow the steps in the documentation and make sure to save 
both the console URL and the password for the admin username. [***Doc Link***](https://ibmdocs-test.dcs.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=manager-starter-installation-cli#exp_login)
