...
Additional storage information is available in the [***public documentation***](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=requirements-storage).
...
the [***public documentation***](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=administering-backup-restore-ai-manager)
:::
...
:::caution
Note that Multi-Zone support is considered a "Tech Preview" feature for v4.1
:::
...
* [Installing Red Hat OpenShift Container Platform and storage tasks required for compliance](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=fips-enabling-support-ai-manager#preinstall)
* [Installing Cloud Pak for AIOps tasks required for compliance](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=fips-enabling-support-ai-manager#install_tasks)
* [Optional conditional tasks required for compliance](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.1?topic=fips-enabling-support-ai-manager#conditional)