...
Additional storage information is available in the [***public documentation***](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/latest?topic=planning-storage-requirements).
...
the [***public documentation***](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/latest?topic=pak-backing-up-restoring-cloud-watson-aiops)
:::
...
* [Installing Red Hat OpenShift Container Platform and storage tasks required for compliance](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/latest?topic=fips-enabling-support-cloud-pak-watson-aiops#preinstall)
* [Installing Cloud Pak for AIOps tasks required for compliance](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/latest?topic=fips-enabling-support-cloud-pak-watson-aiops#install_tasks)
* [Conditional tasks required for compliance](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/latest?topic=fips-enabling-support-cloud-pak-watson-aiops#conditional)