...
:::note If you require your Cloud Pak for AIOps environment to support the
Federal Information Processing Standards (FIPS), there are storage related
...
:::caution Note that Multi-Zone support is only available for ROSA (Red Hat
OpenShift on AWS) and is considered a "Tech Preview" feature for v4.1 :::
