...
- As you are now in the Cloud Pak Administration portal, click on the top right
  icon (Cloud Pak switcher) and select **Automation** to get back to the home
  page of the Cloud Pak for AIOps.
- From the navigation menu, click **Administration** > **Access control**.
...
- Click on **Next**. You should see a final Add users - Summary page as shown
  below:
