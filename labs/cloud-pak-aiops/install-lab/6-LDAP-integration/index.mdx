...
You are not required to follow or execute any of the commands in section 6. The LDAP
server may not be running in your environment. This section is here for informational purposes only.
