...
self-signed certificates for this Lab. Just accept the risk and continue. Make sure you can login as **cpadmin**, 
as shown below, using the password from the previous command.

![](images/login.png)

:::tip
After confirming you can login as **cpadmin**, complete the final Lab section:
* LDAP Integration
:::
