...
#### Creating a File Observer

We will create a file observer to load the topology file we just created. 
...
step. Leave the **Provider** field unchanged, as shown below:
...
from the **Terminal** window, lets submit again the events via the webhook script created in the previous section by running the following command:
...
**This concludes the Cloud Pak for AIOps Alert Correlation Lab**
