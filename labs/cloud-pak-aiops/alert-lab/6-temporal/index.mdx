...
```
bash event-load-kafka.sh temp-events-training.json cp4aiops-cartridge.irdatalayer.replay.alerts
```
...
- (Skip this step if you don't have a **Select data** page) In the **Select
  data** page, set **Start date** as January 1st 2023 and **End date** as
  September 1st, 2023. Leave **Time** unchanged
