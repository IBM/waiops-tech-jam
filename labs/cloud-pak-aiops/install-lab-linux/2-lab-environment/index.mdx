...
* 1 x load balancer server - 2 CPU, 16 Gi RAM, 500 Gi disk
* 3 x control plane nodes - 16 CPU 16 Gi RAM, 200 Gi disk + (2 x 200 Gi disks)
* 6 x worker nodes - 16 CPU, 46 Gi RAM, 200 Gi disk + (1 x 200 Gi disk)
