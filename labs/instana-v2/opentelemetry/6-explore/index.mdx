...
use native Instana instrumentation techniques. In the below snippet, we follow Envoy tracing configuration described here 
https://www.ibm.com/docs/en/instana-observability/current?topic=technologies-monitoring-envoy-proxy#configuring-distributed-tracing
