...
cluster is experiencing one of the follwoing, but you can't understand why?
...
:::danger Don't let your bath tub end up in your downstairs living room

So you purchased a luxury steel bath tub, but your builder spaced out your floor
joists too far apart to achieve the required strength to support your bath tub.

Before you know it, your bath tub has fallen through the floor and is now
sitting in the middle of your living area.
...
One of the most overlooked aspect of any deployment is ensuring the base
...
Genereally speaking, the bigger and more powerful your car, the bigger your car
...
So if the node is reporting that all it's capacity is available, how does the
...
:::caution Debugging and maintencance cost

Since many different symptoms can be experienced as a result of this type of
core component resource starvation, most teams enter into a contionuous reactive
...
1. If your calculations show a value falls below the default, to be on the safe,
   stick with the default value:

   - It may be tempting to squeeze resources futher, however going below the
     defaults may be counter-productive.
...
1. If you are updating an existing cluster, especially in production, then
   manual updates may be the preferred option if more controlled rollout is
   desired, e.g.
   - canary rollout of node reservations to observe impact before updating the
     cluster wholesale.
