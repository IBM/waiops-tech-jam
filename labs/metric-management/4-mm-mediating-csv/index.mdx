...
_Note: If the above command does not show an entry for
...
topic sometimes does not get created properly._
...
_Note: If you need to ingest files in both skinny and wide format, you must
...
must multi-select the data sources, then select "deploy model"._
...
_Note: It is important to be cognizant of the timezone of the data and configure
