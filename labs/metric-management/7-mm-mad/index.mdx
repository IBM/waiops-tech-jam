...
**_Current GA release (3.4.1)_**<br/> High Availability<br/> Support multiple
aggregation interval<br/> Runs on OpenShift<br/> Horizontally scalable<br/> Easy
install<br/> Off-the-shelf Instana connector<br/> Seamless, modern user
experience<br/> **_Future releases_**<br/> Multi-tenancy<br/> Data quality
analysis<br/>

**Features that are currently missing in MAD vs. VM Metric Manager:<br/>**
Metric search (future enhancement)<br/> Anomaly search (future enhancement)<br/>
