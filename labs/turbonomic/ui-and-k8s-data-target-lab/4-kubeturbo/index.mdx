...
The steps in this lab should be performed on the **Apps SNO OpenShift cluster**
to install the **KubeTurbo** agent. It will be configured to connect to the
Turbonomic server.
...
1. In your browser, navigate to your Apps Single Node OpenShift console by
   ...
   You can use the bookmark called **SNO Dashboard** or use the URL
