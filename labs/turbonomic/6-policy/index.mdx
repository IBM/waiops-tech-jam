...
Ssers can define their own policies for each entity in the supply chain based on
...
> **Note:** This is for information only, there is no need to actually edit any
> policy for these labs.
