...
1. Select filter **Equals** and enter the expression `robot-shop`. Make sure no
   other checkboxes are selected then click the **Apply** button:
...
1. Now go back to the Turbonomic dashboard by clicking the green **on** at the
   ...
   are **ACTIONS** now on the Robot Shop application:
