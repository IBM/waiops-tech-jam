...
The
<a href="https://github.com/turbonomic/t8c-install/wiki" target="_blank">t8c-install</a>
repository contains information about installation methods, sizing, architecture
and more.
...
1. Set the storage class:
   ...
   > **Note:** The lab instructions assume you using
