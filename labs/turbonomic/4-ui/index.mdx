...
> **Note:** Screenshots may not fully align to your individual environment. The
> aim of this section is to get familiar with the key UI points of interest.
...
1. Notice that the entities have different colors, where:
   ...
   > application performance and therefore user experience, Turbonomic ARM will
   > recommend, and if enabled to, take the automated actions to proactively
   > ensure application performance whilst making the most efficient use of your
   > infrastructure, resources and cloud budget.
...
> performance in mind. In this way, proactive, automated steps can be taken to
> ensure the applications have the resources they need, when they need them.
>
