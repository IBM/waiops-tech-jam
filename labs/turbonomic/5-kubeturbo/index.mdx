...
1. Now, replace the text **<your turbonomic server URL, please use the
   ...
   **How to get the Turbonomic Server URL:**
   ...
   1. Navigate to **Networking** -> **Routes**, select the **turbonomic project
      and copy the **Location** for **topology-processor\*\*:
...
1. Then click on **Logs** to validate that the probe has successfully connected,
   ...
   You can also use the search field to search for
   `Probe registration succeeded.`
