...
3. **Instana VM** - An Ubuntu VM with the Instana Server and Agent pre-installed
   running on K3s ready for integration with Turbonomic.

In this lab you will install the Turbonomic Server on the AIOps OCP Cluster and
integrate Turbonomic with the Instana Server running on K3s in the Instana
Ubuntu VM.
