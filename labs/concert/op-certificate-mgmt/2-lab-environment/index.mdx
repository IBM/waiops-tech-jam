...
:::note
Note that the **Instana cluster** shown in the following deployment diagram, although part 
of the overall lab environment, it will not be used in this specific lab. Because of this, you still need to provide
...
:::warning
The Lab uses a Root, Intermediate CA and Tomcat certificates all from the private CA included in the lab. The Intermediate CA certificate would last 120 hours (5 days) before expiration. Please make sure to complete the lab 
within 5 days after requesting the lab environment. After 5 days, you can still run the lab but note that the Intermediate CA 
certificate will be shown in Concert as expired.
:::
