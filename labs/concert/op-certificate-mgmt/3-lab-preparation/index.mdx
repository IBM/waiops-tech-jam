...
* Copy the URL of your new repository and save it into the credentials file after **Git_URL**. You will need it later to configure GitHub connection from Concert.
...
* Copy the generated token into the credentials file after **GHCR_PAT**. You will need it later to configure GitHub Authentication in Concert Workflows.
...
* Under **Parameters**, provide the following details:
  ...
  * **Personal Access Token**: the PAT you created during the previous step.
...
Concert Workflows. The Concert Workflows Library can be found [here](https://automation-library.ibm.com/workflows).
