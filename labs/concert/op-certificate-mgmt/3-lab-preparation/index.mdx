...
:::danger
In the **Welcome to IBM Concert!** dialog, make sure to select **Skip**
...
### 3.3.3: Creating a Personal Access Token (PAT)
...
## 3.4: Creating a target environment in Concert
...
## 3.5: Creating GitHub connection from Concert
...
## 3.6: Creating Automation Rules in Concert
