...
* Click on the **Workflows** tab on the top and select the **Authentications tile** 
...
Now that you have the Private Key value for **jammer** user and **demo-apps VM ipAddress**, you are ready to create a new Ansible Authentication.
...
* Under **Service**, search for **IBM Hub - Self**. Make sure to select the Hub Self that has the IBM icon, as shown below:

![IBM Hub - Self](./images/hub-self.png)
