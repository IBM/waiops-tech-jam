...
Let's verify that the Keycloak realm and client were created successfully in the following section.
...
3. The new realm created by `setup-keycloak.sh` script should be listed as `concert-realm`.
