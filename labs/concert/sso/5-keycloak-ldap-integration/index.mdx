...
![User Groups Membership](images/keycloak-alice-user-groups-membership.png)

---

## 5.9: Test LDAP Authentication

Before proceeding to Concert configuration, let's test that users can authenticate via Keycloak using their LDAP credentials.
