...
![Keycloak User Federation LDAP Sync Settings](images/keycloak-userfed-ldap-sync-settings.png)
...
![Keycloak User Federation LDAP Sync Kerberos](images/keycloak-userfed-ldap-sync-kerberos.png)
