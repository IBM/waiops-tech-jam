...
5. Alice will be able to view all applications, such as **HR-application**, that have been granted to her.
...
7. Logout Concert as Alice.

### 7.6.2: Validate object level access as Bob
...
5. Bob will be able to view all applications, such as **HR-application**, that have been granted to him.
...
### 7.6.3: Validate object level access as Charlie
...
5. Charlie will be able to view all applications, such as **HR-application**, which have been granted to him.
