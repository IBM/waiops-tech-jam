...
- ✅ `ou=users,dc=example,dc=com` - Container for user accounts
- ✅ `ou=groups,dc=example,dc=com` - Container for groups
...
|----------|----------|------|-------|
| alice | Alice@123 | Administrator | corporate_it_staff |
| bob | Bob@123 | Editor | hr_staff |
| charlie | Charlie@123 | Viewer | sales_staff |
