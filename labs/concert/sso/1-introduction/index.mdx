...
### 1. An LDAP compliant Directory Server - Users & Groups Directory
There are many LDAP-compliant directory servers available in the market, including commercial and open-source solutions. 
For this lab, OpenLDAP has been selected as the directory service because it is widely adopted, standards-based, and well suited for learning and testing LDAP integrations.<br/>
[OpenLDAP](https://www.openldap.org/doc/admin24/) serves as the centralized user directory, 
storing user accounts, credentials, and organizational structure. It provides:
...
There are many Identity and Access Management (IAM) and Identity Provider (IdP) solutions available in the market, including both commercial and open-source offerings.
For this lab, Keycloak has been selected because it is a widely adopted open-source identity platform that supports industry-standard authentication and authorization protocols.<br/>
