...
Paste the ServiceNow Developer Instance credentials into the `credentials.txt` file. This is a prerequisite
for the Lab as explained in the **Lab Environment** section of this Lab Guide. 
...
:::note
Skip this section if you already have the watsonx.ai credentials set up from a previous lab that used the same Concert instance. 
:::
...
## 3.11 Update the ServiceNow Integration

We need to ensure that Concert Workflows uses the latest ServiceNow integration:

1. From **credentials.txt**, open the **Concert Workflows** link in a new browser tab. 
2. Select **ServiceNow_1.0.69.ssi.zip** and download it by clicking the download icon.
3. From **Concert Workflows → Integration packages** tab, click **Import**.
4. In the **Import Integrations** page, click the **Select integration package** button and select the 
downloaded **ServiceNow_1.0.69.ssi.zip** file.
5. Finally click **Upload integration** and wait for the process to complete.

## 3.12 Remove Data from Previous Labs
