---
title: 4. Instana Server Installation
description:
...
## 4.5: Launch the Instana User interface
...
## 4.6: Turning on features and setting up SMTP
...
## 4.7: Upgrading the Instana server

:::warning Do not perform these steps

You should not perform any steps in this section. We want you to know the
