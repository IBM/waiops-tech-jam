...
- The installation process for a single server self-hosted K3's based Instana.
- Licensing the Instana Server.
- Configuring SMTP for the Instana Server.
- Installing the Instana Agent into a variety of environments (locally on K3s
  with the Instana Server, OpenShift and Linux).
