...
of **1/1** in the READY column or the pods aren't in a **Running** state, wait a
couple more minutes and issue the **oc get pods** command again. It can **take
as much as 15 minutes** before all of the pods are running. If you don't want to
wait, you can proceed to the next steps.
