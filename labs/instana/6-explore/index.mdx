...
utilization of the Kubernetes cluster. ![](images/cluster.png)
...
links in context and leveraging the relationships that are discoved by Instana,
...
that allows you to navigate back to where you were earlier in your nativations.
...
Persective** for the **Robot Shop** application.
...
environment. Initially, this list maybe almost empty shwoing just **All
...
services and endpoints into dashboard that shows the health and performance of a
business application. In this section, you will create and **Application
Persective** for the **Quote of the Day** application.
...
In particular, let's take a look at the **"Depedencies"** tab.

Click on the **Dependencies** tab. ![](images/dependencies.png)
...
this environment, Instana does not include an native mobile applications, but
...
you'll see the **Bee-Travels** application website. Click on the blue link for
the **Bee-Travels** website to drill down for more details.
...
that made the request. This sensitive data can be ommitted by Instana if the
...
Next, we're goint to investigate Instana's unbounded analytics. Navigate to the
...
One the left side, you'll see a mumber of about of the box filters. Expand the
