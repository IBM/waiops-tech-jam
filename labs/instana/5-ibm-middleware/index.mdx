...
If you copied the bookmarks select **Quote of the Day** otherwise find the URL
by running the command `oc get route -n qotd --kubeconfig kubeconfig-apps` and
opening the URL with open this URL with http:// in front.
