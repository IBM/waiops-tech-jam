...
Let's verify that things are running. From the bastion host issue the **oc get
pods** command against the **qotd** namespace/project.
...
The main log file is `/opt/instana/agent/data/log/agent.log`
