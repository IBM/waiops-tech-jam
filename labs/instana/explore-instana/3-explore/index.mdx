...
- Email: **admin@instana.local**
- Password: **Passw0rd**

{/* ![](images/login-updated.png) */}
<img src={require('./images/login-updated.png').default} alt="login-updated" width="500" />
...
<img src={require('./images/kubernetes.png').default} alt="kubernetes" width="60%" />
...
<img src={require('./images/host-query.png').default} alt="host-query" width="40%" />
...
<img src={require('./images/instana-flyover.png').default} alt="instana-flyover" width="70%" />
...
<img src={require('./images/mqace-flyover.png').default} alt="mqace-flyover" width="70%" />
...
<img src={require('./images/table-content.png').default} alt="table-content" width="50%" />
...
{/* ![](images/plus.png) */}
<img src={require('./images/plus.png').default} alt="plus" width="60%" />
...
<img src={require('./images/pizza-box.png').default} alt="pizza-box" width="60%" />
...
![](images/mq-ace-host-dashboard-updated.png)
...
<img src={require('./images/applications-menu.png').default} alt="applications-menu" width="60%" />
...
![](images/add-app-perspective-updated.png)
...
2. Add a filter, type in **kubernetes namespace** and then select **Kubernetes namespace name**. Then,
...
2. Add filters for Service Name, Kubernetes Namespace Name and Endpoint Name as per
...
You may need to wait a short while for Instana to generate the complete topology.
...
This topology is discovered automatically.

You can see transactions flowing
...
<img src={require('./images/flyover-qm.png').default} alt="flyover-qm" width="50%" />
...
{/* ![](images/click-qm.png) */}
<img src={require('./images/click-qm.png').default} alt="click-qm" width="50%" />
...
<img src={require('./images/qotd-engraving-service-endpoint-list.png').default} alt="qotd-engraving-service-endpoint-list" width="70%" />
...
<img src={require('./images/qotd-analyze-engraving-calls.png').default} alt="qotd-analyze-engraving-calls" width="70%" />
...
will navigate to the IBM MQ Queue dashboard for this queue.
...
<img src={require('./images/websites-and-mobile-apps.png').default} alt="websites-and-mobile-apps" width="60%" />
...
<img src={require('./images/analytics.png').default} alt="analytics" width="50%" />
...
<img src={require('./images/type-of-calls.png').default} alt="type-of-calls" width="50%" />
...
<img src={require('./images/upper-filter.png').default} alt="upper-filter" width="50%" />
...
<img src={require('./images/group-statements.png').default} alt="group-statements" width="65%" />
...
<img src={require('./images/share-button.png').default} alt="share-button" width="40%" />
...
<img src={require('./images/share-dialog.png').default} alt="share-dialog" width="70%" />
