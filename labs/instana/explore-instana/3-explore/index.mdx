...
If the _Installing Instana Agents_ screen is show you can skip it and select
**"Go to Instana!"**.

![](images/continue-to-instana.png)
...
contained within the zones represents the OpenShift SNO cluster named Apps, the
