...
the SNO cluster that we installed the OCP Instana Agent onto.
...
## 4.2: Explore the Infrastructure View
...
specified a zone name when you performed the install of the Instana Agent or
specified a zone name in the Instana Aganet configuration file. The towers
contained within the zones represents the OpenShift SNO cluster, the Instana
server, and the virtual machine running ACE and MQ.
...
means that you did not specify a zone name in the Agent configuration.
...
## 4.3: Create an Application Perspective for Robot Shop
...
## 4.4: Create an Application Perspective for QOTD
...
## 4.6: Websites and Mobile App Monitoring
