...
2. **Apps SNO Cluster** - An instance of Single Node OpenShift where demo
   ...
   VM to demonstrate further the Instana Servers monitoring capabilities.
...
[Jam-in-a-Box: Instana - Administer](https://techzone.ibm.com/my/reservations/create/649cd8c0fc016400174bed2a)
collection.
