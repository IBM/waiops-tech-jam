...
new Terminal tab using `ssh jammer@instana`.

:::tip

Use the Bastion host (Guacamole) to get to the Instana machine. Open a terminal
window by selecting **Activities** at the top left of the screen and then the
terminal icon.
