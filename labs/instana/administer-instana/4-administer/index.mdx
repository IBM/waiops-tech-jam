...
## 4.2: Create an Analytics Based Smart Alert
...
## 4.3: Create a Static Threshold (Event)
...
## 4.4: Setting up an Offline Event
...
## 4.5: Setup an Alert for the New Event
