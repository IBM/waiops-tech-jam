...
needs to have permissions one some MQ objects such as queues and topics.  If the ACE sensor is not working, 
look at the MQ log to see if there are any permissions errors.
