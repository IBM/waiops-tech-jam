...
You may see the error shown below, there is currently an issue rendering WebGL
content on the Instana Infrastructure page in the Firefox browser. We are
working with the TechZone team to resolve this issue. In the meantime you will
need to reference the screenshots in this lab guide.

![](../../../_common/images/webgl-error.png)
