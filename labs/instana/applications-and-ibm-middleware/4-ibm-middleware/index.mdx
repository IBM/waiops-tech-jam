...
you are running.  There are unique packages for x64_64 Linux, Power Linux, AIX, etc.
...
causes Instana to monitor the top 10 processes in terms of CPU usage and the
top 10 based on memory usage
