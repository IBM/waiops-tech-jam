---
title: 4. Application monitoring
...
## 4.1 Create an Application in Instana
...
Switch to "Advanced mode" and name your application `otel-demo`.
...
## 4.2 Review Application Perspective
