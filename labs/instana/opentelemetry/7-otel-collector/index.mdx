...
In this scenario, you will learn how to deliver custom logs to the Instana backend using OpenTelemetry Contrib Collector.
...
:::tip
Please note, the Logging feature accepting the OpenTelemetry custom logs require License Add-on. Please read and
follow this instructions https://www.ibm.com/docs/en/instana-observability/current?topic=opentelemetry-collecting-linux-system-logs
:::
...
Let's review the more advanced log example. Please open a example.FDC file by typing
...
As you can see, the configuration is more complex, comparing to the previous example. We've added "operators"
section to make sure, the log file will be parsed correctly.

Let's start the OtelCol Contrib Collector using the new config-advanced.yaml by this command
