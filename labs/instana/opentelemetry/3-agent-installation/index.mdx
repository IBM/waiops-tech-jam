...
This script contains all the necessary commands to install the Instana
...
Please note the below example does not contain real values. The
...
All pods should be in RUNNING state, all of them should also have READY
