...
<MultiChoiceQuestion
  questionNumber="1"
  question="How do you install a Synthetic Point of Presence?"
  answers={[
    "It is installed by default",
    "As RPM",
    "Using Helm",
    "With Kubernetes Operator only",
  ]}
...
<MultiChoiceQuestion
  questionNumber="2"
  question="An Instana Synthetic Point of Presence can only be installed on the same cluster with the backend."
  answers={["True", "False"]}
  correctAnswer="False"
/>
