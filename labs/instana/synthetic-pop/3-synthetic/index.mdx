...
In a new browser tab open address `http://qotd-api.apps.demo-apps.ibmdte.local/usecase` to see the reply of REST API of "Quote of the Day" returned to Instana:
...
To edit the existing test, Open Instana tab in a browser and click **Synthetic Monitoring -> Tests**, select recently created test **"Quote of the Day REST API check"** to return to the test, click on the **Configuration** tab and then select
the **edit** pencil.
