...
> **&#9888; HINT: Static host agents require no internet connection to the
> Instana repository, and are recommended in restrictive network setups.**
...
the screen. ![](images/linuxInstall.png)
...
> **&#9888; HINT: Zones are used to organize the Instana Agents (and sensors).
> Many customers create zones for lines of business, data center locations,
> public cloud regions, etc**
...
You will see output similar to what's shown below ![](images/install.png)
...
if the instana-agent pods are running. ![](images/getPods.png)
...
<span style={{color: "red"}}>
  This section is here for informational purposes. There are no steps to
  execute.
</span>
...
the Instana Agent installed on a traditioanl server. Instructions would be
...
> **&#9888; HINT: Agent will actually read and use ANY yaml file in that
> directory.**
...
> **&#9888; HINT: Instana agent configuration file must be a proper YAML - if
> your changes are not applied, make sure that it's not a formatting error**
