...
install of Instana, there are no **Alert Channels** define.
...
- Enter the email address to notify. Notice that there is an **Add Email** link
  on the right side if you want to add multiple Email addresses.
- Next, click the **Test Channel** button. This will attempt to send a test
  ...
  access to the Email destination.
...
Leave the default of **"Slow Calls"** ![](images/slowCalls.png)
...
setting. ![](images/sensitivity.png)
...
Scroll down further. ![](images/options3.png)
...
**Smart Alerts** tab at the top of the screen. ![](images/viewSmartAlerts.png)
...
Users, Groups, Log Managemnet Integration, and more
...
the page. ![](images/filterEvents.png)
...
- Select the option of whether you want your Event to get correlated into
  Incidents
- Select a Grace Period. ![](images/newEvent1.png)
...
Queue Depth Percentage"**. ![](images/newEvent4.png)
...
the dropdown list. ![](images/allEntities.png)
...
[Lucenes Query Language](https://www.ibm.com/docs/en/instana-observability/current?topic=instana-filtering-dynamic-focus)
...
Your **Dynamic Focus Query** should look like this. ![](images/selfType.png)
...
Click on the **"+ New Alert"** link ![](images/newAlert.png)
...
Type"** dropdown list and select **"IBM MQ Queue"** ![](images/filterQueue.png)
...
the **"Add 1 Event"** button at the bottom. ![](images/chooseEvent.png)
...
Select the **"Selected Entities Only"** option ![](images/selectedEntities.png)
...
Next, click on the **"+ Add Alert Channels"** link ![](images/alertChannel.png)

A dialog will open with a list of available **"Alert Channels"**. Select the
**Alert Channel** that you created earlier.

Then, click the **"Add 1 Channel"** button. ![](images/selectChannel.png)
