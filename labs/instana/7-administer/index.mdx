...
- Enter a name for the alert. The name can be anything, but should be
  ...
  admins, like in this case call it something MQ related such as **MQ Email
  Channel**
...
- Next, click the **Test Channel** button. This will attempt to send a test
  ...
  access to the Email destination. In order to check an email in Instana lab
  server, login as **jammer** user to your Instana server and type "mail"
...
Click on **Applications** and then, select the **"Quote of the Day"**
application.
...
Scroll down to the **"Scope"** section. This determines which Entities this
Alert will apply to.
