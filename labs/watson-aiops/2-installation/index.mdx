...
another cloud provider, or on-premise. The exception to this would be the setup
...
on-premise deployments, a good option would be VMware vSphere storage,
...
on-premise Probe to Watson for AIOps Event Manager"
